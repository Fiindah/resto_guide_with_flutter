...
class ThemeFooter extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          const Text('© 2026 Resto Guide', style: TextStyle(fontSize: 12)),
          ...
          IconButton(
            tooltip: 'Light Theme',
            icon: Icon(Icons.light_mode, color: iconColor(AppThemeMode.light)),
            onPressed: () => themeProvider.setTheme(AppThemeMode.light),
          ),
          IconButton(
            tooltip: 'Dark Theme',
            icon: Icon(Icons.dark_mode, color: iconColor(AppThemeMode.dark)),
